...
parser.add_argument('--raw_data_path', type=str, default='/home/ubuntu18/lx/OANet/raw_data/',
  help='raw data path. default:../raw_data/')
parser.add_argument('--dump_dir', type=str, default='/home/ubuntu18/lx/OANet/data_dumpyfcc/',
...
if __name__ == "__main__":
    ...
    yfcc_te_known = Dataset(config.raw_data_path+'yfcc100m/', config.dump_dir, 'yfcc-'+config.desc_name+'-testknown.hdf5', \
        train_seqs, 'test', config.desc_name, \
        config.vis_th, 100, None)
