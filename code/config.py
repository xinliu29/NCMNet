...
data_arg.add_argument(
    "--data_tr", type=str, default='../../data/yfcc/yfcc-sift-2000-train.hdf5', help=""
    "name of the dataset for train")
data_arg.add_argument(
    "--data_va", type=str, default='../../data/yfcc/yfcc-sift-2000-val.hdf5', help=""
    "name of the dataset for valid")
data_arg.add_argument(
    "--data_te", type=str, default='../../data/yfcc/yfcc-sift-2000-test.hdf5', help=""
